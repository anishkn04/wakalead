      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            />
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">WakaLead</h1>
              <p className="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">WakaTime Leaderboard</p>
            </div>
          </div>
